...
import com.nsc.eshop.service.image.ImageService;
...
public class ImageController {
    ...
    public ResponseEntity<ApiResponse> saveImages(@RequestParam List<MultipartFile> files, @RequestParam Long productId) {
        try {
            List<ImageDto> imagesDto = imageService.saveImages(productId, files);
            return ResponseEntity.ok(new ApiResponse("Image uploaded successfully!", imagesDto));
        } catch (Exception e) {
